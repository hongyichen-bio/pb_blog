...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection order_index
     ...
     * @method Grid\Column|Collection order_index(string $label = null)
     ...
     * @property Show\Field|Collection order_index
     ...
     * @method Show\Field|Collection order_index(string $label = null)
